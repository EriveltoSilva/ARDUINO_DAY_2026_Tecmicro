...
const char* Gemini_Token = "AIzaSyDOawXaJRDbWGrLk0LzEOqzv37fs2c4110";
...
void loop() 
{
  ...
  if (https.begin("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + (String)Gemini_Token)) {  // HTTPS
